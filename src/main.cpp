...
const string strMessageMagic = "NCRcoin Signed Message..:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NCRcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "This NCRcoin at 16 nov 2017";
        CTransaction txNew;
		...
		block.nNonce = !fTestNet ? 352820 : 352820;
        ...
        assert(block.hashMerkleRoot == uint256("0x61f3e1e66f90cbd3f018222e4eedfe0395c212c8f19e727cb416fedbcf90a049"));
